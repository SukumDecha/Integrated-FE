...
import { Shield, Mail, Lock, CheckCircle2 } from 'lucide-vue-next'
...
const pageContent = computed(() => {
  ...
  if (path.includes('register') || path.includes('signup')) {
    return {
      title: 'Join Us Today!',
      description:
        'Create your account and start your amazing shopping journey with exclusive deals and personalized recommendations.',
      icon: Shield,
    }
    ...
    return {
      ...
      description:
        "Please enter your new password. Make sure it's strong and secure to protect your account.",
      icon: Lock,
    }
  } else {
    // Default (Sign In)
...
<template>
  ...
  <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div
      class="hidden lg:flex absolute top-0 left-0 w-[45%] h-full bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600 shadow-2xl"
    >
      <!-- Decorative Pattern -->
      ...
      <div
        class="relative h-full flex flex-col items-center justify-center text-white px-12 w-full"
      >
